...
Line 239: raise Exception("Failed to load new data")
"""
            ...
            with patch('builtins.open', create=True) as mock_open:
                ...
                with patch('load_data.GradCafeDataLoader') as MockLoader:
                    ...
                    with patch('psycopg.connect') as mock_connect:
                        ...
                        # This will trigger line 239: raise Exception("Failed to load new data")
                        mock_loader.load_data_from_jsonl.return_value = False
                        ...
                        with patch('threading.Thread') as MockThread:
                            ...
                            assert scraping_status['error'] is not None
                            # The error message should contain our specific exception
                            assert 'Failed to load new data' in scraping_status['error']
